...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QLabel, QGroupBox, QHBoxLayout, QVBoxLayout, QRadioButton, QButtonGroup, QTextEdit, QListWidget, QLineEdit, QInputDialog
import json
...
def search_tag():
    tag = field_tag.text()
    if btn_tag_search.text() == 'Искать заметки по тегу' and tag:
        notes_filtered = {}
        for note in notes:
